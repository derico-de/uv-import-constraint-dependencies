...
class TestReadPyproject:
    ...
    def test_read_pyproject_with_constraints(
        ...
        """Test reading pyproject.toml with existing constraint_dependencies."""
...
"""
    ...
    def test_get_no_constraint_dependencies(
        ...
        """Test getting constraints when tool.uv exists but no constraint_dependencies."""
...
"""
    ...
    def test_merge_empty_existing(
        ...
        """Test merging when existing constraint_dependencies is empty."""
        pyproject_path = create_pyproject_file(pyproject_with_tool_uv)
